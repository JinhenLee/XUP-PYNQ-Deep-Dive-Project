...
proc create_root_design { parentCell } {
  ...
  # Create instance: buttons_switches, and set properties
  set buttons_switches [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 buttons_switches ]
  ...
  connect_bd_net -net buttons_1 [get_bd_ports buttons] [get_bd_pins buttons_switches/In0]
  connect_bd_net -net processing_system7_0_GPIO_O [get_bd_pins leds/Din] [get_bd_pins processing_system7_0/GPIO_O]
  connect_bd_net -net switches_1 [get_bd_ports switches] [get_bd_pins buttons_switches/In1]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins buttons_switches/dout] [get_bd_pins processing_system7_0/GPIO_I]
  connect_bd_net -net xlslice_0_Dout [get_bd_ports leds] [get_bd_pins leds/Dout]
